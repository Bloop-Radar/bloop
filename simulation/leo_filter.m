...
p(1,1)  = -2.8249;   p(2,1)  = 0.2667;
p(1,2)  = -2.2852;   p(2,2)  = 0.2667;
p(1,3)  = -2.2852;   p(2,3)  = 0.1;
p(1,4)  = -2.1035;   p(2,4)  = 0.1;
p(1,5)  = -2.1035;   p(2,5)  = 0.8721;
p(1,6)  = -1.9035;   p(2,6)  = 0.8721;
p(1,7)  = -1.9035;   p(2,7)  = 0.1;
p(1,8)  = -0.8615;   p(2,8)  = 0.1;
p(1,9)  = -0.8615;   p(2,9)  = 1.0704;
p(1,10) = -0.6615;   p(2,10) = 1.0704;
p(1,11) = -0.6615;   p(2,11) = 0.1;
p(1,12) = 0.6615;    p(2,12) = 0.1;
p(1,13) = 0.6615;    p(2,13) = 1.0704;
p(1,14) = 0.8615;    p(2,14) = 1.0704;
p(1,15) = 0.8615;    p(2,15) = 0.1;
p(1,16) = 1.9035;    p(2,16) = 0.1;
p(1,17) = 1.9035;    p(2,17) = 0.8721;
p(1,18) = 2.1035;    p(2,18) = 0.8721;
p(1,19) = 2.1035;    p(2,19) = 0.1;
p(1,20) = 2.2852;    p(2,20) = 0.1;
p(1,21) = 2.2852;    p(2,21) = 0.2667;
p(1,22) = 2.8249;    p(2,22) = 0.2667;
p(1,23) = 2.8249;    p(2,23) = -0.2667;
p(1,24) = 2.2852;    p(2,24) = -0.2667;
p(1,25) = 2.2852;    p(2,25) = -0.1;
p(1,26) = -2.2852;   p(2,26) = -0.1;
p(1,27) = -2.2852;   p(2,27) = -0.2667;
p(1,28) = -2.8249;   p(2,28) = -0.2667;
...
mesh.x = SmoothMeshLines([0.6615, 2.2, 2.5551], resolution/3, 1.5, 0);
mesh.x = SmoothMeshLines([-MSL_length -mesh.x mesh.x MSL_length], resolution, 1.5, 0);
mesh.y = SmoothMeshLines([0, 0.2667, 1.1], resolution/3, 1.5, 0);
...
portstop  = [mesh.x(38),  MSL_width/2, 0];
...
portstop  = [mesh.x(end-38),  MSL_width/2, 0];
